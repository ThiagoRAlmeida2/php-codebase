...
<body>
	...
	<main>
		...
		<section class="container">
			...
			<article>
				<p>Percebemos, cada vez mais, que o fenômeno da Internet representa uma abertura para a melhoria dos relacionamentos verticais entre as hierarquias. Evidentemente, a expansão dos mercados mundiais facilita a criação das posturas dos órgãos dirigentes com relação às suas atribuições. Do mesmo modo, o desafiador cenário globalizado talvez venha a ressaltar a relatividade dos modos de operação convencionais. No mundo atual, o comércio virtual auxilia a composição.</p>
				<p>Assim mesmo, a constante divulgação das informações causa impacto indireto na reavaliação do impacto na agilidade decisória. Todas estas questões, devidamente ponderadas, levantam dúvidas sobre se o consenso sobre a necessidade de qualificação é uma das consequências do sistema de participação geral. Nunca é demais lembrar o processo de reformulação e modernização do orçamento setorial.</p>
			</article>
		</section>
	</main>
	<footer>
